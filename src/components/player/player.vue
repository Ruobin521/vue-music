<template>
  <div class="player" v-show="playList.length>0">
    <transition name="normal" @enter="enter" @after-enter="afterEnter" @leave="leave" @after-leave="afterLeave">
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="middle" @touchstart.prevent="middleTouchStart" @touchmove.prevent="middleTouchMove" @touchend.prevent="middleTouchEnd">
          ...
          <scroll class="middle-r" ref="lyricList" v-if="currentLyric && currentLyric.lines" :data="currentLyric && currentLyric.lines">
        ...
        <div class="bottom">
          ...
          <div class="progress-wrapper">
            ...
            <div class="progress-bar-wrapper">
              <progressbar ref="progressBar" :percent="percent" @percentChange="onProgressBarChange"></progressbar>
            </div>
    ...
    <audio ref="audio" :src="currentSong.url" @play="ready" @error="error" @timeupdate="onUpdateTime" @ended="end" @pause="paused"></audio>
  </div>
</template>
    ...
    methods: {
      ...
      resetCurrentIndex(list) {
        let index = list.findIndex((p) => {
          return p.id === this.currentSong.id
        })
